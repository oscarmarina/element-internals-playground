...
| `invalid`                 |         | `boolean`                                                                                                                      | `false`                         | When true, the input is currently invalid based on the browser's built-in validation rules                                                                                                                                                                       |                |
...
| Name                 | Privacy | Type      | Default | Description | Inherited From |
| -------------------- | ------- | --------- | ------- | ----------- | -------------- |
| `__fieldsetDisabled` | private | `boolean` | `false` |             |                |

##### Methods

| Name                   | Privacy | Description                                                                                                                            | Parameters                                                          | Return | Inherited From |
| ---------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------ | -------------- |
| `_syncFormState`       | private |                                                                                                                                        | `input: HTMLInputElement \| HTMLTextAreaElement, formValue: string` |        |                |
